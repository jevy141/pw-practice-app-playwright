...
```
Error: A snapshot doesn't exist at C:\Users\sohan\OneDrive\Desktop\PlayWright Demo\pw-practice-app\tests\visualTesting.spec.ts-snapshots\Form-Layouts-page-radio-buttons-1-dev-win32.png, writing actual.
```
...
```ts
  ...
  17 |     await usingTheGridForm.getByLabel("Option 1").check({ force: true })
  ...
  22 |     
  23 |     // Now using visual assertions
  24 | 
> 25 |     await expect(usingTheGridForm).toHaveScreenshot()
     |     ^ Error: A snapshot doesn't exist at C:\Users\sohan\OneDrive\Desktop\PlayWright Demo\pw-practice-app\tests\visualTesting.spec.ts-snapshots\Form-Layouts-page-radio-buttons-1-dev-win32.png, writing actual.
  26 | 
  27 | 
  28 |     
